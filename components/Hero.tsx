...
export default function Hero({ data }: { data: HeroData }) {
  ...
  return (
    <section className="px-6 py-10 md:py-16" style={{ position: "relative", overflow: "hidden" }}>
      <HeroNetwork />
      <div style={{ position: "relative", zIndex: 1 }}>
        <div className={`max-w-6xl mx-auto${entered ? " hero-enter" : ""}`}>
          {/* Eyebrow */}
          ...
          <h1 className="font-serif text-6xl md:text-7xl lg:text-[5rem] text-navy leading-[1.08] mb-7 max-w-3xl">
          ...
          <div className="flex flex-wrap items-center gap-5">
            <a href={data.cta1.href} className="px-6 py-3 bg-navy text-white text-sm font-medium rounded-full hover:bg-ink transition-colors">
              {data.cta1.label}
            </a>
            <a
              href={data.cta2.href}
        ...
        {/* Stats row */}
        <div className="max-w-6xl mx-auto border-t border-border pt-10 mt-16">
